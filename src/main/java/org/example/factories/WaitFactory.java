...
public final class WaitFactory {
    ...
    private static final Function<By, WebElement> CLICKABLE_BY_WEB_ELEMENT_FUNCTION = by -> new WebDriverWait(DriverManager.getDriver(), FrameworkConstants.EXPLICIT_WAIT)
      .until(ExpectedConditions.elementToBeClickable(by));
    private static final Function<By, WebElement> PRESENCE_BY_WEB_ELEMENT_FUNCTION = by -> new WebDriverWait(DriverManager.getDriver(), FrameworkConstants.EXPLICIT_WAIT)
